    ...
    <DropdownMenuItem className="text-[20px]" onClick={()=>router.push("/contact")}>Contact</DropdownMenuItem>
      ...
      <div className="hidden lg:flex lg:text-[#FFFFFF] lg:text-[22px] lg:mt-3">
        <ul className="flex space-x-[50px] justify-center">
          <li className="hover:text-gray-300 hover:text-[22px] hover:cursor-pointer" onClick={()=>router.push("/")}>HOME</li>
          <li className="hover:text-gray-300 hover:text-[22px] hover:cursor-pointer" onClick={()=>router.push("/products")}>TRAILERS</li>
          <li className="hover:text-gray-300 hover:text-[22px] hover:cursor-pointer" onClick={()=>router.push("/about")}>ABOUT US</li>
          <li className="hover:text-gray-300 hover:text-[22px] hover:cursor-pointer" onClick={()=>router.push("/contact")}>CONTACT</li>
      ...
      <div className="hidden lg:flex lg:space-x-4 lg:mt-1">
        ...
        <Input
          type="email"
          className="text-[18px] pl-[15px] py-[1px] h-[44px] w-[300px] bg-white text-[#808080] rounded-[10px]"
          placeholder="Find Our Search"
          endContent={
            <CiSearch className="text-black w-[24px] h-[24px]"/>
          }
        />
